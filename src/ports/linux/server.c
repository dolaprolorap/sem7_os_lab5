...
//     printf("Начало прослушивания по порту %d\n", PORT);

//     while (1) {
//         client_fd = accept(server_fd, (struct sockaddr*)&address, &addrlen);
//         if (client_fd < 0) {
//             perror("Не удалось прочесть ответ");
//             continue;
//         }
...
//         if (strncmp(buffer, "GET /data", 9) == 0) {
//             send_data(client_fd, buffer);
//         } else if (strncmp(buffer, "GET /data/hourly", 16) == 0) {

//         } else if (strncmp(buffer, "GET /data/daily", 15) == 0) {
